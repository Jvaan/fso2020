...
describe('author with most blogs', () => {
  const expectedResult1 = { author: 'Edsger W. Dijkstra', blogs: 1 }
  ...
  const expectedResult2 = { author: 'Robert C. Martin', blogs: 3 }
...
describe('author with most likes', () => {
  const expectedResult1 = { author: 'Edsger W. Dijkstra', likes: 5 }
  test('when list has only one blog', () => {
  ...
  const expectedResult2 = { author: 'Edsger W. Dijkstra', likes: 17 }
  test('of a bigger list', () => {
